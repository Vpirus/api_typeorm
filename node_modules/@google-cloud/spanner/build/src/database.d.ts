...
declare class Database extends common.GrpcServiceObject {
    ...
    writeAtLeastOnce(mutations: MutationSet, options: CallOptions): Promise<CommitResponse>;
    writeAtLeastOnce(mutations: MutationSet, callback: CommitCallback): void;
    writeAtLeastOnce(mutations: MutationSet, options: CallOptions, callback: CommitCallback): void;
    /**
