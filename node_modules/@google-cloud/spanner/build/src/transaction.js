...
class Snapshot extends events_1.EventEmitter {
    ...
    begin(gaxOptionsOrCallback, cb) {
        ...
        return (0, instrument_2.startTrace)('Snapshot.begin', traceConfig, span => {
    ...
    read(table, requestOrCallback, cb) {
        ...
        return (0, instrument_2.startTrace)('Snapshot.read', traceConfig, span => {
    ...
    run(query, callback) {
        ...
        (0, instrument_2.startTrace)('Snapshot.run', traceConfig, span => {
...
class Dml extends Snapshot {
    runUpdate(query, callback) {
        ...
        return (0, instrument_2.startTrace)('Dml.runUpdate', traceConfig, span => {
...
class Transaction extends Dml {
    ...
    commit(optionsOrCallback, cb) {
        ...
        return (0, instrument_2.startTrace)('Transaction.commit', traceConfig, span => {
            if (this.id) {
    ...
    rollback(gaxOptionsOrCallback, cb) {
        ...
        return (0, instrument_2.startTrace)('Transaction.rollback', traceConfig, span => {
            if (!this.id) {
                const err = new Error('Transaction ID is unknown, nothing to rollback.');
                (0, instrument_2.setSpanError)(span, err);
                span.end();
                callback(err);
                return;
...
class PartitionedDml extends Dml {
    ...
    runUpdate(query, callback) {
        ...
        return (0, instrument_2.startTrace)('PartitionedDml.runUpdate', traceConfig, span => {
